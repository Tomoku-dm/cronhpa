...
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".spec.template.spec.minReplicas",description="MaxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up."

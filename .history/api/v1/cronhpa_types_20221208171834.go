...
// +kubebuilder:printcolumn:name="MAXPODS",type="string",JSONPath=".spec.template.spec.minReplicas",description="MaxReplicas is the lower limit for the number of replicas to which the autoscaler can scale down"
